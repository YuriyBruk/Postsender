...
public class MailSender {
    ...
    public static void send(String mailTo, String subject, String message, ArrayList<String> files) {
        String host = "smtp.gmail.com";
        String port = "587";
        String mailFrom = "testing.yuriy@gmail.com";
        String password = "Marcus2307";
    ...
    public static void sendFromTxt(String mailTo, String subject, String message, ArrayList<String> files) {
        String host = "smtp.gmail.com";
        String port = "587";
        String mailFrom = "testing.yuriy@gmail.com";
        String password = "Marcus2307";
